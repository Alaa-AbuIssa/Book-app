...
export class UpdateBook extends Component {
  state = {
    bookName: this.props.previousBookData.bookName,
    describtion: this.props.previousBookData.describtion,
    imageUrl: this.props.previousBookData.image,
  };
  updateBooksHandler = async () => {
    ...
    const updatedData = await axios.put(
      `${process.env.REACT_APP_SERVER}/${this.props.previousBookData.index}`,
      formData
    );
